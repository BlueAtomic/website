...
<html lang="en">
    ...
    <?php include 'assets/php/users.php';?>
    ...
    <body>
        <div>
            ...
            <p> <?php getName(1052129761285132419) ?> </p> -->
            <div class="card" style="width: 18rem;">
                <img class="card-img-top" src="<?php getAv(1052129761285132419) ?>" alt="Card image cap" style="border-radius: 50%;background: transparent !important">
                <div class="card-body">
